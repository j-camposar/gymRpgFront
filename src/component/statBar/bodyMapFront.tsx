...
const BodyMapFront = ({ 
  ...
  const getMuscleStyle = (muscleId: string) => {
    ...
    return {
      ...
      filter: isActive ? `drop-shadow(0 0 8px ${highlightColor})` : 'none',
  ...
  return (
    <div className={`${className} bg-[#0d0d0d] p-6 rounded-2xl border border-gray-800 shadow-2xl animate-in fade-in duration-500`}>
      <svg
        viewBox="0 0 200 420"
